...
const OrdersMatrixScreen = ({
  ...
  // Debug logging
  console.log("OrdersMatrixScreen - agentClients count:", agentClients.length);
  console.log("OrdersMatrixScreen - selectedAgent:", selectedAgent);
  console.log("OrdersMatrixScreen - matrixData keys:", Object.keys(matrixData).length);
  ...
  return (
    <div className="flex">
      ...
      <div className="flex-1 space-y-4">
        {/* Stats Cards - Only visible in view mode */}
        {!editMode && (
          <div className="grid grid-cols-5 gap-4 p-4">
            <div className="bg-white p-4 rounded-lg shadow">
              <p className="text-sm text-gray-600">Clienti Afisati</p>
            ...
            <div className="bg-white p-4 rounded-lg shadow">
              <p className="text-sm text-gray-600">Plata la zi</p>
            ...
            <div className="bg-white p-4 rounded-lg shadow">
              <p className="text-sm text-gray-600">Total Valoare</p>
        ...
        {/* Controls Section - Sticky at top */}
        <div className="sticky top-0 z-20 bg-white shadow-md rounded-lg p-4">
        ...
        <div className="bg-white p-4 rounded-lg shadow overflow-x-auto mx-4">
          <table className="w-full text-sm">
            ...
            <tbody>
              ...
              {/* TOTAL row as last row of table */}
              <tr className="border-t-2 border-gray-400 bg-yellow-100">
                <td className="px-1 py-2 font-bold sticky left-0 bg-yellow-100 z-10" style={{ minWidth: "180px", width: "180px", maxWidth: "180px" }}>
                  TOTAL
                </td>
