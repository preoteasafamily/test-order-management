...
const ExportScreenGrouped = ({
  ...
  const handleSaveGroup = async () => {
    ...
    // Use master product's descriere as the group name
            ...
            <div className="p-6">
              ...
              <div className="mb-4">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded p-2 mb-3 text-sm text-blue-800">
                  ℹ️ Selectați produsul principal care va reprezenta această grupare
                </div>
                <select
                ...
                {masterProduct && (
                  <p className="text-sm text-green-600 mt-2">
                    ✓ Nume grupare: {masterProduct.descriere}
                  </p>
                )}
              </div>
